...
exports.splitAccesskey = splitAccesskey;
...
var _ContextMenuManager = __webpack_require__(15);
...
var _ContextMenuEventHandler = __webpack_require__(14);

var _ContextMenuEventHandler2 = _interopRequireDefault(_ContextMenuEventHandler);

var _ContextMenuOperations = __webpack_require__(16);
...
var _jqueryContextMenuFunction = __webpack_require__(17);
...
contextMenu.setInputValues = _helpers.setInputValues;
contextMenu.getInputValues = _helpers.getInputValues;
contextMenu.fromMenu = _html5builder2.default;

contextMenu.defaults = _defaults2.default;
...
$.fn.contextMenu = _jqueryContextMenuFunction2.default;
            ...
            case 'input':
                switch ($node.attr('type')) {
                    case 'text':
                        item = {
                            type: 'text',
                            name: label || (0, _helpers.inputLabel)(node),
                            disabled: !!$node.attr('disabled'),
                            value: $node.val()
                        };
                        break;
    ...
    _createClass(ContextMenuEventHandler, [{
        ...
        value: function contextmenu(e) {
            ...
            if (!$this.hasClass('context-menu-disabled')) {
                ...
                if (e.data.build) {
                    var built = e.data.build(e, this.$currentTrigger);
    ...
    _createClass(ContextMenuOperations, [{
        ...
        value: function create(e, opt, root) {
            ...
            $.each(opt.items, function (key, item) {
                ...
                if (typeof item.accesskey !== 'undefined') {
                    var aks = (0, _helpers.splitAccesskey)(item.accesskey);
                ...
                if (item.type && root.types[item.type]) {
                    ...
                    if (item.type && item.type !== 'sub' && item.type !== 'html' && item.type !== 'cm_separator') {
                        $input.on('focus', root.manager.handle.focusInput).on('blur', root.manager.handle.blurInput);
        ...
        value: function layer(e, opt, zIndex) {
            ...
            }).data('contextMenuRoot', opt).insertBefore(this).on('contextmenu', opt.manager.handle.abortevent).on('mousedown', opt.manager.handle.layerClick);
        ...
        value: function processPromises(e, opt, root, promise) {
            ...
            function finishPromiseProcess(opt, root, items) {
                ...
                opt.items = items;
                root.manager.op.create(e, opt, root);
                root.manager.op.update(e, opt, root);
                root.positionSubmenu.call(opt.$node, e, opt.$menu);
            }
...
exports.default = function (operation) {
    ...
    if (this.length > 0) {
        ...
        _ContextMenuEventHandler2.default.contextmenu.call($o.target, $o);
    }
